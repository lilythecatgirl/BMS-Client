...
void Utils::systemPlay(std::string name) {
	std::string path = getenv("APPDATA") + std::string("\\..\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\PacketSkid\\Assets\\") + std::string(name);
...
void Utils::makeFolderInPacket(std::string file) {
	std::string path = getenv("APPDATA") + std::string("\\..\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\PacketSkid\\") + std::string(file);
	// Creating File
	if (mkdir(path.c_str()) == -1)
		return;
	else
...
void Utils::makeFolderInAssets(std::string file) {
	std::string path = getenv("APPDATA") + std::string("\\..\\Local\\Packages\\Microsoft.MinecraftUWP_8wekyb3d8bbwe\\RoamingState\\PacketSkid\\Assets\\") + std::string(file);
	// Creating File
	if (mkdir(path.c_str()) == -1)
		return;
	else
